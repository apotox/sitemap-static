...
test('sitemap - zero', function (t) {
  sitemap(concat(function (res) {
    if (process.env.UPDATE) {
      fs.writeFileSync('fixtures/zero.xml', res);
    }
    t.equal(res, fs.readFileSync('fixtures/zero.xml', 'utf8'));
    t.end();
  }), {
      targetExt:'.md', //new feature
      pretty:true,
      findRoot: 'fixtures/zero',
